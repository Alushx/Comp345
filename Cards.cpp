...
void Deck ::generateDeck() {
    ...
    cards[13] = Card(gd.DIRE, ctype.SINGLE, act.BUILD_CITY);
    cards[14] = Card(gd.DIRE_GIANT, ctype.AND, act.ADD_3_ARMY,act.DESTROY_1_ARMY);
    cards[15] = Card(gd.DIRE_EYE, ctype.SINGLE, act.ADD_4_ARMY);
    cards[16] = Card(gd.DIRE_GOBLIN, ctype.SINGLE, act.MOVE_4_ARMY);
    cards[17] = Card(gd.DIRE_OGRE, ctype.SINGLE, act.MOVE_2_ARMY);

    cards[18] = Card(gd.LAKE, ctype.OR, act.ADD_2_ARMY,act.MOVE_3_ARMY);
    cards[19] = Card(gd.FOREST_ELF, ctype.OR,  act.ADD_3_ARMY,act.MOVE_2_ARMY);
    cards[20] = Card(gd.FOREST_GNOME, ctype.SINGLE,act.MOVE_2_ARMY);
    cards[21] = Card(gd.FOREST_TREE_TOWN , ctype.SINGLE, act.BUILD_CITY);
    cards[22] = Card(gd.GRAVEYARD, ctype.SINGLE, act.ADD_2_ARMY);
    cards[23] = Card(gd.NOBLE_HILLS, ctype.SINGLE, act.ADD_3_ARMY);

    cards[24] = Card(gd.NOBLE_KNIGHT, ctype.AND, act.ADD_4_ARMY, act.DESTROY_1_ARMY);
    cards[25] = Card(gd.NOBLE_UNICORN, ctype.AND, act.MOVE_4_ARMY, act.ADD_1_ARMY);
    cards[26] = Card(gd.NIGHT_HYDRA, ctype.AND, act.MOVE_4_ARMY,act.DESTROY_1_ARMY);
    cards[27] = Card(gd.NIGHT_VILLAGE, ctype.SINGLE, act.BUILD_CITY);
    cards[28] = Card(gd.NIGHT_WIZARD, ctype.AND, act.ADD_4_ARMY, act.DESTROY_1_ARMY);
    cards[29] = Card(gd.MOUNTAIN_DWARF, ctype.AND, act.ADD_2_ARMY, act.DESTROY_1_ARMY);

    cards[30] = Card(gd.MOUNTAIN_TREASURY, ctype.SINGLE, act.MOVE_3_ARMY);
    cards[31] = Card(gd.CASTLE, ctype.OR, act.ADD_4_ARMY,act. BUILD_CITY);
    cards[32] = Card(gd.CASTLE_2, ctype.AND, act.MOVE_3_ARMY,act.BUILD_CITY);
    cards[33] = Card(gd.FOREST_PIXIE, ctype.SINGLE, act.MOVE_4_ARMY);
    cards[34] = Card(gd.STRONGHOLD, ctype.SINGLE, act.BUILD_CITY);
